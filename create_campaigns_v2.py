#!/usr/bin/env python3
"""
Campaign Creation Tool V2 - CLI Interface

Automated end-to-end campaign creation for TrafficJunky campaigns.
VERSION 2: Supports both NATIVE and INSTREAM ad formats.
"""
...
from campaign_automation_v2.models import CampaignBatch
from campaign_automation_v2.orchestrator import create_campaigns
from campaign_automation_v2.checkpoint import CheckpointManager
from campaign_templates import generate_campaign_name, DEFAULT_SETTINGS, get_templates_for_format, VALID_AD_FORMATS
